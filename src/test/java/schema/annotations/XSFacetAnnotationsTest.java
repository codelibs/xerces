...
public class XSFacetAnnotationsTest extends TestCase {
    ...
    private void st1AnnotationTest(Boolean synth) {
        ...
        assertEquals(0, annotations.getLength(), "TEST1_NO_ANNOTATIONS_" + synth);
    }
    ...
    private void st2AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT3\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        String expected2 = trim("<annotation id=\"ANNOT4\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST2_NO_ANNOTATION_" + synth);
        XSObjectList annotations = minLength.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TEST2_NO_ANNOTATIONS_" + synth);

        XSFacet maxLength = (XSFacet) st.getFacets().item(2);
        annotation = maxLength.getAnnotation();
        assertEquals(expected2, trim(annotation.getAnnotationString()), "TEST2_NO_ANNOTATION_" + synth);
        annotations = maxLength.getAnnotations();
        assertEquals(expected2, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TEST2_NO_ANNOTATIONS_" + synth);
    }
    ...
    private void st3AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT5\" sn:attr=\"SYNTH2\"" + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST3_ANNOTATION_" + synth);
        XSObjectList annotations = whitespace.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES3_ANNOTATIONS_" + synth);
    }
    ...
    private void st4AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT6\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST4_ANNOTATION_" + synth);
        XSObjectList annotations = minInclusive.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES4_ANNOTATIONS_" + synth);
    }
    ...
    private void st5AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT7\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST5_ANNOTATION_" + synth);
        XSObjectList annotations = maxInclusive.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES5_ANNOTATIONS_" + synth);
    }
    ...
    private void st6AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT8\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST6_ANNOTATION_" + synth);
        XSObjectList annotations = fractionDigits.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES6_ANNOTATIONS_" + synth);
    }
    ...
    private void st7AnnotationTest(Boolean synth) {
        String expected = trim("<annotation sn:attr=\"SYNTH2\" id=\"ANNOT9\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = fractionDigits.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST7_ANNOTATION_" + synth);
        XSObjectList annotations = fractionDigits.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES7_ANNOTATIONS_" + synth);
    }
    ...
    private void st8AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT10\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = fractionDigits.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST8_ANNOTATION_" + synth);
        XSObjectList annotations = fractionDigits.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES8_ANNOTATIONS_" + synth);
    }
    ...
    private void st9AnnotationTest(Boolean synth) {
        String expected = trim("<annotation sn:attr=\"SYNTH2\" id=\"ANNOT11\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = fractionDigits.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST9_ANNOTATION_" + synth);
        XSObjectList annotations = fractionDigits.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES79_ANNOTATIONS_" + synth);
    }
    ...
    private void st10AnnotationTest(Boolean synth) {
        String expected = trim("<annotation sn:attr=\"SYNTH2\" id=\"ANNOT12\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = fractionDigits.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST10_ANNOTATION_" + synth);
        XSObjectList annotations = fractionDigits.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES10_ANNOTATIONS_" + synth);
    }
    ...
    private void st11AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT14\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\"  xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = maxInclusive.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST11_ANNOTATION_" + synth);
        XSObjectList annotations = maxInclusive.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES11_ANNOTATIONS_" + synth);
    }
    ...
    private void st12AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT15\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\"  xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = length.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST12_ANNOTATION_" + synth);
        XSObjectList annotations = length.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES12_ANNOTATIONS_" + synth);
    }
    ...
    private void st13AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT16\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\"  xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST12_ANNOTATION_" + synth);
        XSObjectList annotations = length.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES13_ANNOTATIONS_" + synth);
    }
    ...
    private void st14AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT17\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\"  xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");

        String expected1 = trim("<annotation sn:attr=\"SYNTH1\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
        ...
        XSAnnotation annotation = minLength.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST14_ANNOTATION_" + synth);
        XSObjectList annotations = minLength.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES14_ANNOTATIONS_" + synth);
        ...
        if (synth.booleanValue() == true) {
            ...
            annotation = maxLength.getAnnotation();
            assertEquals(expected1, trim(annotation.getAnnotationString()), "TEST14_ANNOTATION_" + synth);
            annotations = maxLength.getAnnotations();
            assertEquals(expected1, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES14_ANNOTATIONS_" + synth);
        }
    }
    ...
    private void st15AnnotationTest(Boolean synth) {
        String expected = trim("<annotation sn:attr=\"SYNTH1\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\" xmlns:sn=\"SyntheticAnnotation\"> "
                + "<documentation>SYNTHETIC_ANNOTATION</documentation></annotation>");
        ...
        if (synth.booleanValue() == true) {
            ...
            assertEquals(expected, trim(annotation.getAnnotationString()), "TEST15_ANNOTATION_" + synth);
            XSObjectList annotations = maxLength.getAnnotations();
            assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES15_ANNOTATIONS_" + synth);
        } else {
            XSAnnotation annotation = maxLength.getAnnotation();
            assertNull(annotation, "TEST15_ANNOTATION_" + synth);
            XSObjectList annotations = maxLength.getAnnotations();
            assertEquals(0, annotations.getLength(), "TES15_ANNOTATIONS_" + synth);
        }
    }
    ...
    private void st16AnnotationTest(Boolean synth) {
        String expected = trim("<annotation id=\"ANNOT18\" " + "xmlns=\"http://www.w3.org/2001/XMLSchema\" "
                + "xmlns:sv=\"XSFacetTest\"  xmlns:sn=\"SyntheticAnnotation\" >" + "</annotation>");
        ...
        XSAnnotation annotation = maxLength.getAnnotation();
        assertEquals(expected, trim(annotation.getAnnotationString()), "TEST16_ANNOTATION_" + synth);
        XSObjectList annotations = maxLength.getAnnotations();
        assertEquals(expected, trim(((XSAnnotation) annotations.item(0)).getAnnotationString()), "TES16_ANNOTATIONS_" + synth);
    }

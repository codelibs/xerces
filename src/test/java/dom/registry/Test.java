...
public class Test {
    ...
    public static void main(String argv[]) {
        ...
        try {
            ...
            Assertion.verify(i == CoreDOMImplementationImpl.getDOMImplementation());
        ...
        try {
            DOMImplementation i = registry.getDOMImplementation("XML MutationEvents");

            Assertion.verify(i == DOMImplementationImpl.getDOMImplementation());

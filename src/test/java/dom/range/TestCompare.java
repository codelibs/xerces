...
public class TestCompare {
     ...
     * buildRanges() method.
     */
    private final int[][] results_START_TO_START = { { 0, -1, -1, -1 }, // range[0].compareBoundaryPoints( range[x] )
     ...
     * buildRanges() method.
     */
    private final int[][] results_START_TO_END = { { 1, 1, 1, 1 }, // range[0].compareBoundaryPoints( range[x] )
     ...
     * buildRanges() method.
     */
    private final int[][] results_END_TO_START = { { -1, -1, -1, -1 }, // range[0].compareBoundaryPoints( range[x] )
     ...
     * buildRanges() method.
     */
    private final int[][] results_END_TO_END = { { 0, -1, -1, -1 }, // range[0].compareBoundaryPoints( range[x] )
            { 1, 0, 1, 1 }, // range[1].compareBoundaryPoints( range[x] )
            { 1, -1, 0, 1 }, // range[2].compareBoundaryPoints( range[x] )
            { 1, -1, -1, 0 }, // range[3].compareBoundaryPoints( range[x] )
    };

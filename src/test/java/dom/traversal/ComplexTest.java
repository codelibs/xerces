...
public class ComplexTest extends AbstractTestCase {
    ...
    private static final String DOC1 = "<?xml version='1.0' encoding='UTF-8'?>" + "<!DOCTYPE root [" + "<!ENTITY a '<r/>0<s/>'>"
            + "<!ENTITY b '1&a;<t/>&a;2'>" + "<!ENTITY c '&b;'>" + "]><root>&c;3<i/>&c;</root>";

    private static final String DOC2 = "<?xml version='1.0' encoding='UTF-8'?>" + "<!DOCTYPE root [" + "<!ENTITY a '<child/>'>"
            + "<!ENTITY b '<!-- comment -->&a;<![CDATA[text]]>'>" + "<!ENTITY c '&b;'>" + "]><root>&c;</root>";

...
public abstract class AbstractDateTimeDV extends TypeValidator {
    ...
    static final class DateTimeData implements XSDateTime {
        ...
        public DateTimeData(int year, int month, int day, int hour, int minute, double second, int utc, String originalValue,
        ...
        public Object clone() {
            DateTimeData dt = new DateTimeData(this.year, this.month, this.day, this.hour, this.minute, this.second, this.utc,

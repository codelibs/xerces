...
public class XSAttributeChecker {
    ...
    static {
        ...
        allAttrs[ATT_PROCESS_C_D] =
                new OneAttr(SchemaSymbols.ATT_PROCESSCONTENTS, DT_PROCESSCONTENTS, ATTIDX_PROCESSCONTENTS, INT_ANY_STRICT);
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (attrName.startsWith("xml")) {
                ...
                // like any other schema attribute.
                        ...
                        && (SchemaSymbols.ELT_SCHEMA.equals(elName) || SchemaSymbols.ELT_DOCUMENTATION.equals(elName))) {
                    attrURI = null;
                }
            }
            ...
            if (max != SchemaSymbols.OCCURRENCE_UNBOUNDED) {
                if (min > max) {
                    reportSchemaError("p-props-correct.2.1",
                            new Object[] { elName, attrValues[ATTIDX_MINOCCURS], attrValues[ATTIDX_MAXOCCURS] }, element);
    ...
    private Object validate(Object[] attrValues, String attr, String ivalue, int dvIndex, XSDocumentInfo schemaDoc)
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals(SchemaSymbols.ATTVAL_EXTENSION)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3",
                                new Object[] { value, "(#all | List of (extension | restriction | substitution))" });
                    }
                }
            }
            ...
            if (value.equals(SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals(SchemaSymbols.ATTVAL_EXTENSION)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3",
                                new Object[] { value, "(#all | List of (extension | restriction))" });
                    }
                }
            }
            retValue = fXIntPool.getXInt(choice);
            ...
            if (value.equals(SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals(SchemaSymbols.ATTVAL_LIST)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3",
                                new Object[] { value, "(#all | List of (list | union | restriction))" });
                    }
                }
            }
            retValue = fXIntPool.getXInt(choice);
            ...
            if (value.equals(SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals(SchemaSymbols.ATTVAL_EXTENSION)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3",
                                new Object[] { value, "(#all | List of (extension | restriction | list | union))" });
                    }
                }
            }
            retValue = fXIntPool.getXInt(choice);
        ...
        case DT_NAMESPACE:
            ...
            if (value.equals(SchemaSymbols.ATTVAL_TWOPOUNDANY)) {
                ...
                try {
                    ...
                    throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3",
                            new Object[] { value, "((##any | ##other) | List of (anyURI | (##targetNamespace | ##local)) )" });
                }

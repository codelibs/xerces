...
abstract class XSDAbstractParticleTraverser extends XSDAbstractTraverser {
    ...
    XSParticleDecl traverseAll(Element allDecl, XSDocumentInfo schemaDoc, SchemaGrammar grammar, int allContextFlags, XSObject parent) {
        ...
        particle = checkOccurrences(particle, SchemaSymbols.ELT_ALL, (Element) allDecl.getParentNode(), allContextFlags,
     ...
     * @return
     */
    private XSParticleDecl traverseSeqChoice(Element decl, XSDocumentInfo schemaDoc, SchemaGrammar grammar, int allContextFlags,
            boolean choice, XSObject parent) {

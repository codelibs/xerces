...
import org.codelibs.xerces.wml.WMLNoopElement;

/**
 * Implementation of WMLNoopElement interface for WML no-operation elements.
 *
...
public class WMLNoopElementImpl extends WMLElementImpl implements WMLNoopElement {
    ...
    /**
     * Constructs a new WML noop element with the specified owner document and tag name.
     *

...
public interface ItemPSVI {
     ...
     *
     * @return an immutable ItemPSVI instance with the same data
     */
     ...
     *
     * @return the validation context or null
     */
     ...
     *
     * @return one of VALIDITY_NOTKNOWN, VALIDITY_INVALID, or VALIDITY_VALID
     */
     ...
     *
     * @return one of VALIDATION_NONE, VALIDATION_PARTIAL, or VALIDATION_FULL
     */
     ...
     *
     * @return a StringList of error codes or an empty list
     */
     ...
     *
     * @return a StringList of error messages or an empty list
     */
     ...
     *
     * @return the actual normalized value or null
     ...
     *
     * @return the type code for the actual normalized value
     * @exception XSException
     *   NOT_SUPPORTED_ERR: Raised if the implementation does not support this
     *   method.
     *
     ...
     *
     * @return a ShortList of item value types
     * @exception XSException
     *   NOT_SUPPORTED_ERR: Raised if the implementation does not support this
     *   method.
     *
     ...
     * is not specified.
     *
     * @return the schema value or null
     */
     ...
     *
     * @return the schema default value or null
     */
     ...
     *
     * @return true if the value was specified in the schema, false otherwise
     */

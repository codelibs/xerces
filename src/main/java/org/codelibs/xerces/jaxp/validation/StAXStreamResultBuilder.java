...
final class StAXStreamResultBuilder implements StAXDocumentHandler {
    ...
    public void startDocument(XMLStreamReader reader) throws XMLStreamException {
        ...
        fStreamWriter.writeStartDocument(encoding != null ? encoding : "UTF-8", version != null ? version : "1.0");
    }
        ...
        try {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (fAttrName.prefix.length() > 0) {
                    fStreamWriter.writeAttribute(fAttrName.prefix, fAttrName.uri != null ? fAttrName.uri : "", fAttrName.localpart,

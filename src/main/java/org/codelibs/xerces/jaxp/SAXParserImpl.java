...
public class SAXParserImpl extends javax.xml.parsers.SAXParser implements JAXPConstants, PSVIProvider {
    ...
    private static final String NAMESPACE_PREFIXES_FEATURE = Constants.SAX_FEATURE_PREFIX + Constants.NAMESPACE_PREFIXES_FEATURE;
        ...
        if (grammar != null) {
            ...
            if (grammar instanceof XSGrammarPoolContainer) {
                ...
                fSchemaValidatorComponentManager =
                        new SchemaValidatorConfiguration(config, (XSGrammarPoolContainer) grammar, fSchemaValidationManager);
            }
            ...
            if (fSAXParser != null) {
                ...
                if (JAXP_SCHEMA_LANGUAGE.equals(name)) {
                    ...
                    if (val != null && W3C_XML_SCHEMA.equals(val)) {
                        ...
                        throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(fConfiguration.getLocale(),
                                "jaxp-order-not-supported", new Object[] { JAXP_SCHEMA_LANGUAGE, JAXP_SCHEMA_SOURCE }));
                    }
                    return;
                }
            }
        ...
        private void setSchemaValidatorFeature(String name, boolean value) throws SAXNotRecognizedException, SAXNotSupportedException {
            ...
            // This should never be thrown from the schema validator.
                ...
                if (e.getType() == XMLConfigurationException.NOT_RECOGNIZED) {
                    throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(fConfiguration.getLocale(),
